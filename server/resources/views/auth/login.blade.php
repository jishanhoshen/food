                            ...
                            <div class="flex-auto p-6">
                                <form role="form" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="min-h-6 mb-0.5 block pl-12">
                                        ...
                                        <p class="mx-auto text-sm flex justify-between">
                                            <label
                                            ...
                                            @if (Route::has('password.request'))
                                                <a href="{{ route('password.request') }}"
                                                    class="text-right relative z-10 font-semibold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text">{{ __('Forgot Your Password?') }}</a>
                                            @endif
                                        </p>
                                    </div>
                                    <div class="text-center">
                                        <button type="submit"
                                            class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-xs ease-soft-in tracking-tight-soft bg-gradient-to-tl from-blue-600 to-cyan-400 hover:scale-102 hover:shadow-soft-xs active:opacity-85">{{ __('Login') }}</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-sm">
                                        ...
                                        <a href="{{ route('register') }}"
                                            class="relative z-10 font-semibold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text">{{ __('Sign Up') }}</a>
                                    </p>
                                </div>
                            @endif
                        </div>
